...
`,Bg="\u2028",Hg="\u2029";function kg(t){const e=t;let n=0,i=1,r=1,s=0;const a=R=>e[R]===Fg&&e[R+1]===Yt,o=R=>e[R]===Yt,l=R=>e[R]===Hg,c=R=>e[R]===Bg,u=R=>a(R)||o(R)||l(R)||c(R),f=()=>n,d=()=>i,_=()=>r,E=()=>s,v=R=>a(R)||l(R)||c(R)?Yt:e[R],m=()=>v(n),p=()=>v(n+s);function A(){return s=0,u(n)&&(i++,r=0),a(n)&&n++,n++,r++,e[n]}function x(){return a(n+s)&&s++,s++,e[n+s]}function M(){n=0,i=1,r=1,s=0}function L(R=0){s=R}function b(){const R=n+s;for(;R!==n;)A();s=0}return{index:f,line:d,column:_,peekOffset:E,charAt:v,currentChar:m,currentPeek:p,next:A,peek:x,reset:M,resetPeek:L,skipToPeek:b}}const fi=void 0,Gg=".",du="'",Vg="tokenizer";function zg(t,e={}){const n=e.location!==!1,i=kg(t),r=()=>i.index(),s=()=>Lg(i.line(),i.column(),i.index()),a=s(),o=r(),l={currentType:14,offset:o,startLoc:a,endLoc:a,lastType:14,lastOffset:o,lastStartLoc:a,lastEndLoc:a,braceNest:0,inLinked:!1,text:""},c=()=>l,{onError:u}=e;function f(h,g,I,...N){const G=c();if(g.column+=I,g.offset+=I,u){const q=n?Na(G.startLoc,g):null,D=Zr(h,q,{domain:Vg,args:N});u(D)}}function d(h,g,I){h.endLoc=s(),h.currentType=g;const N={type:g};return n&&(N.loc=Na(h.startLoc,h.endLoc)),I!=null&&(N.value=I),N}const _=h=>d(h,14);function E(h,g){return h.currentChar()===g?(h.next(),g):(f(Ie.EXPECTED_TOKEN,s(),0,g),"")}function v(h){let g="";for(;h.currentPeek()===Xn||h.currentPeek()===Yt;)g+=h.currentPeek(),h.peek();return g}function m(h){const g=v(h);return h.skipToPeek(),g}function p(h){if(h===fi)return!1;const g=h.charCodeAt(0);return g>=97&&g<=122||g>=65&&g<=90||g===95}function A(h){if(h===fi)return!1;const g=h.charCodeAt(0);return g>=48&&g<=57}function x(h,g){const{currentType:I}=g;if(I!==2)return!1;v(h);const N=p(h.currentPeek());return h.resetPeek(),N}function M(h,g){const{currentType:I}=g;if(I!==2)return!1;v(h);const N=h.currentPeek()==="-"?h.peek():h.currentPeek(),G=A(N);return h.resetPeek(),G}function L(h,g){const{currentType:I}=g;if(I!==2)return!1;v(h);const N=h.currentPeek()===du;return h.resetPeek(),N}function b(h,g){const{currentType:I}=g;if(I!==8)return!1;v(h);const N=h.currentPeek()===".";return h.resetPeek(),N}function R(h,g){const{currentType:I}=g;if(I!==9)return!1;v(h);const N=p(h.currentPeek());return h.resetPeek(),N}function k(h,g){const{currentType:I}=g;if(!(I===8||I===12))return!1;v(h);const N=h.currentPeek()===":";return h.resetPeek(),N}function S(h,g){const{currentType:I}=g;if(I!==10)return!1;const N=()=>{const q=h.currentPeek();return q==="{"?p(h.peek()):q==="@"||q==="%"||q==="|"||q===":"||q==="."||q===Xn||!q?!1:q===Yt?(h.peek(),N()):O(h,!1)},G=N();return h.resetPeek(),G}function C(h){v(h);const g=h.currentPeek()==="|";return h.resetPeek(),g}function X(h){const g=v(h),I=h.currentPeek()==="%"&&h.peek()==="{";return h.resetPeek(),{isModulo:I,hasSpace:g.length>0}}function O(h,g=!0){const I=(G=!1,q="",D=!1)=>{const H=h.currentPeek();return H==="{"?q==="%"?!1:G:H==="@"||!H?q==="%"?!0:G:H==="%"?(h.peek(),I(G,"%",!0)):H==="|"?q==="%"||D?!0:!(q===Xn||q===Yt):H===Xn?(h.peek(),I(!0,Xn,D)):H===Yt?(h.peek(),I(!0,Yt,D)):!0},N=I();return g&&h.resetPeek(),N}function ie(h,g){const I=h.currentChar();return I===fi?fi:g(I)?(h.next(),I):null}function B(h){const g=h.charCodeAt(0);return g>=97&&g<=122||g>=65&&g<=90||g>=48&&g<=57||g===95||g===36}function $(h){return ie(h,B)}function Y(h){const g=h.charCodeAt(0);return g>=97&&g<=122||g>=65&&g<=90||g>=48&&g<=57||g===95||g===36||g===45}function te(h){return ie(h,Y)}function J(h){const g=h.charCodeAt(0);return g>=48&&g<=57}function ae(h){return ie(h,J)}function oe(h){const g=h.charCodeAt(0);return g>=48&&g<=57||g>=65&&g<=70||g>=97&&g<=102}function ue(h){return ie(h,oe)}function fe(h){let g="",I="";for(;g=ae(h);)I+=g;return I}function ee(h){m(h);const g=h.currentChar();return g!=="%"&&f(Ie.EXPECTED_TOKEN,s(),0,g),h.next(),"%"}function ce(h){let g="";for(;;){const I=h.currentChar();if(I==="{"||I==="}"||I==="@"||I==="|"||!I)break;if(I==="%")if(O(h))g+=I,h.next();else break;else if(I===Xn||I===Yt)if(O(h))g+=I,h.next();else{if(C(h))break;g+=I,h.next()}else g+=I,h.next()}return g}function pe(h){m(h);let g="",I="";for(;g=te(h);)I+=g;return h.currentChar()===fi&&f(Ie.UNTERMINATED_CLOSING_BRACE,s(),0),I}function Se(h){m(h);let g="";return h.currentChar()==="-"?(h.next(),g+=`-${fe(h)}`):g+=fe(h),h.currentChar()===fi&&f(Ie.UNTERMINATED_CLOSING_BRACE,s(),0),g}function Me(h){return h!==du&&h!==Yt}function Re(h){m(h),E(h,"'");let g="",I="";for(;g=ie(h,Me);)g==="\\"?I+=Le(h):I+=g;const N=h.currentChar();return N===Yt||N===fi?(f(Ie.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER,s(),0),N===Yt&&(h.next(),E(h,"'")),I):(E(h,"'"),I)}function Le(h){const g=h.currentChar();switch(g){case"\\":case"'":return h.next(),`\\${g}`;case"u":return ye(h,g,4);case"U":return ye(h,g,6);default:return f(Ie.UNKNOWN_ESCAPE_SEQUENCE,s(),0,g),""}}function ye(h,g,I){E(h,g);let N="";for(let G=0;G<I;G++){const q=ue(h);if(!q){f(Ie.INVALID_UNICODE_ESCAPE_SEQUENCE,s(),0,`\\${g}${N}${h.currentChar()}`);break}N+=q}return`\\${g}${N}`}function Ve(h){return h!=="{"&&h!=="}"&&h!==Xn&&h!==Yt}function y(h){m(h);let g="",I="";for(;g=ie(h,Ve);)I+=g;return I}function U(h){let g="",I="";for(;g=$(h);)I+=g;return I}function P(h){const g=I=>{const N=h.currentChar();return N==="{"||N==="%"||N==="@"||N==="|"||N==="("||N===")"||!N||N===Xn?I:(I+=N,h.next(),g(I))};return g("")}function V(h){m(h);const g=E(h,"|");return m(h),g}function z(h,g){let I=null;switch(h.currentChar()){case"{":return g.braceNest>=1&&f(Ie.NOT_ALLOW_NEST_PLACEHOLDER,s(),0),h.next(),I=d(g,2,"{"),m(h),g.braceNest++,I;case"}":return g.braceNest>0&&g.currentType===2&&f(Ie.EMPTY_PLACEHOLDER,s(),0),h.next(),I=d(g,3,"}"),g.braceNest--,g.braceNest>0&&m(h),g.inLinked&&g.braceNest===0&&(g.inLinked=!1),I;case"@":return g.braceNest>0&&f(Ie.UNTERMINATED_CLOSING_BRACE,s(),0),I=ne(h,g)||_(g),g.braceNest=0,I;default:{let G=!0,q=!0,D=!0;if(C(h))return g.braceNest>0&&f(Ie.UNTERMINATED_CLOSING_BRACE,s(),0),I=d(g,1,V(h)),g.braceNest=0,g.inLinked=!1,I;if(g.braceNest>0&&(g.currentType===5||g.currentType===6||g.currentType===7))return f(Ie.UNTERMINATED_CLOSING_BRACE,s(),0),g.braceNest=0,re(h,g);if(G=x(h,g))return I=d(g,5,pe(h)),m(h),I;if(q=M(h,g))return I=d(g,6,Se(h)),m(h),I;if(D=L(h,g))return I=d(g,7,Re(h)),m(h),I;if(!G&&!q&&!D)return I=d(g,13,y(h)),f(Ie.INVALID_TOKEN_IN_PLACEHOLDER,s(),0,I.value),m(h),I;break}}return I}function ne(h,g){const{currentType:I}=g;let N=null;const G=h.currentChar();switch((I===8||I===9||I===12||I===10)&&(G===Yt||G===Xn)&&f(Ie.INVALID_LINKED_FORMAT,s(),0),G){case"@":return h.next(),N=d(g,8,"@"),g.inLinked=!0,N;case".":return m(h),h.next(),d(g,9,".");case":":return m(h),h.next(),d(g,10,":");default:return C(h)?(N=d(g,1,V(h)),g.braceNest=0,g.inLinked=!1,N):b(h,g)||k(h,g)?(m(h),ne(h,g)):R(h,g)?(m(h),d(g,12,U(h))):S(h,g)?(m(h),G==="{"?z(h,g)||N:d(g,11,P(h))):(I===8&&f(Ie.INVALID_LINKED_FORMAT,s(),0),g.braceNest=0,g.inLinked=!1,re(h,g))}}function re(h,g){let I={type:14};if(g.braceNest>0)return z(h,g)||_(g);if(g.inLinked)return ne(h,g)||_(g);switch(h.currentChar()){case"{":return z(h,g)||_(g);case"}":return f(Ie.UNBALANCED_CLOSING_BRACE,s(),0),h.next(),d(g,3,"}");case"@":return ne(h,g)||_(g);default:{if(C(h))return I=d(g,1,V(h)),g.braceNest=0,g.inLinked=!1,I;const{isModulo:G,hasSpace:q}=X(h);if(G)return q?d(g,0,ce(h)):d(g,4,ee(h));if(O(h))return d(g,0,ce(h));break}}return I}function T(){const{currentType:h,offset:g,startLoc:I,endLoc:N}=l;return l.lastType=h,l.lastOffset=g,l.lastStartLoc=I,l.lastEndLoc=N,l.offset=r(),l.startLoc=s(),i.currentChar()===fi?d(l,14):re(i,l)}return{nextToken:T,currentOffset:r,currentPosition:s,context:c}}const Wg="parser",Xg=/(?:\\\\|\\'|\\u([0-9a-fA-F]{4})|\\U([0-9a-fA-F]{6}))/g;function Yg(t,e,n){switch(t){case"\\\\":return"\\";case"\\'":return"'";default:{const i=parseInt(e||n,16);return i<=55295||i>=57344?String.fromCodePoint(i):"�"}}}function $g(t={}){const e=t.location!==!1,{onError:n,onWarn:i}=t;function r(x,M,L,b,...R){const k=x.currentPosition();if(k.offset+=b,k.column+=b,n){const S=e?Na(L,k):null,C=Zr(M,S,{domain:Wg,args:R});n(C)}}function s(x,M,L,b,...R){const k=x.currentPosition();if(k.offset+=b,k.column+=b,i){const S=e?Na(L,k):null;i(Ng(M,S,R))}}function a(x,M,L){const b={type:x};return e&&(b.start=M,b.end=M,b.loc={start:L,end:L}),b}function o(x,M,L,b){e&&(x.end=M,x.loc&&(x.loc.end=L))}function l(x,M){const L=x.context(),b=a(3,L.offset,L.startLoc);return b.value=M,o(b,x.currentOffset(),x.currentPosition()),b}function c(x,M){const L=x.context(),{lastOffset:b,lastStartLoc:R}=L,k=a(5,b,R);return k.index=parseInt(M,10),x.nextToken(),o(k,x.currentOffset(),x.currentPosition()),k}function u(x,M,L){const b=x.context(),{lastOffset:R,lastStartLoc:k}=b,S=a(4,R,k);return S.key=M,L===!0&&(S.modulo=!0),x.nextToken(),o(S,x.currentOffset(),x.currentPosition()),S}function f(x,M){const L=x.context(),{lastOffset:b,lastStartLoc:R}=L,k=a(9,b,R);return k.value=M.replace(Xg,Yg),x.nextToken(),o(k,x.currentOffset(),x.currentPosition()),k}function d(x){const M=x.nextToken(),L=x.context(),{lastOffset:b,lastStartLoc:R}=L,k=a(8,b,R);return M.type!==12?(r(x,Ie.UNEXPECTED_EMPTY_LINKED_MODIFIER,L.lastStartLoc,0),k.value="",o(k,b,R),{nextConsumeToken:M,node:k}):(M.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,L.lastStartLoc,0,vn(M)),k.value=M.value||"",o(k,x.currentOffset(),x.currentPosition()),{node:k})}function _(x,M){const L=x.context(),b=a(7,L.offset,L.startLoc);return b.value=M,o(b,x.currentOffset(),x.currentPosition()),b}function E(x){const M=x.context(),L=a(6,M.offset,M.startLoc);let b=x.nextToken();if(b.type===9){const R=d(x);L.modifier=R.node,b=R.nextConsumeToken||x.nextToken()}switch(b.type!==10&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(b)),b=x.nextToken(),b.type===2&&(b=x.nextToken()),b.type){case 11:b.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(b)),L.key=_(x,b.value||"");break;case 5:b.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(b)),L.key=u(x,b.value||"");break;case 6:b.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(b)),L.key=c(x,b.value||"");break;case 7:b.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(b)),L.key=f(x,b.value||"");break;default:{r(x,Ie.UNEXPECTED_EMPTY_LINKED_KEY,M.lastStartLoc,0);const R=x.context(),k=a(7,R.offset,R.startLoc);return k.value="",o(k,R.offset,R.startLoc),L.key=k,o(L,R.offset,R.startLoc),{nextConsumeToken:b,node:L}}}return o(L,x.currentOffset(),x.currentPosition()),{node:L}}function v(x){const M=x.context(),L=M.currentType===1?x.currentOffset():M.offset,b=M.currentType===1?M.endLoc:M.startLoc,R=a(2,L,b);R.items=[];let k=null,S=null;do{const O=k||x.nextToken();switch(k=null,O.type){case 0:O.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(O)),R.items.push(l(x,O.value||""));break;case 6:O.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(O)),R.items.push(c(x,O.value||""));break;case 4:S=!0;break;case 5:O.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(O)),R.items.push(u(x,O.value||"",!!S)),S&&(s(x,oc.USE_MODULO_SYNTAX,M.lastStartLoc,0,vn(O)),S=null);break;case 7:O.value==null&&r(x,Ie.UNEXPECTED_LEXICAL_ANALYSIS,M.lastStartLoc,0,vn(O)),R.items.push(f(x,O.value||""));break;case 8:{const ie=E(x);R.items.push(ie.node),k=ie.nextConsumeToken||null;break}}}while(M.currentType!==14&&M.currentType!==1);const C=M.currentType===1?M.lastOffset:x.currentOffset(),X=M.currentType===1?M.lastEndLoc:x.currentPosition();return o(R,C,X),R}function m(x,M,L,b){const R=x.context();let k=b.items.length===0;const S=a(1,M,L);S.cases=[],S.cases.push(b);do{const C=v(x);k||(k=C.items.length===0),S.cases.push(C)}while(R.currentType!==14);return k&&r(x,Ie.MUST_HAVE_MESSAGES_IN_PLURAL,L,0),o(S,x.currentOffset(),x.currentPosition()),S}function p(x){const M=x.context(),{offset:L,startLoc:b}=M,R=v(x);return M.currentType===14?R:m(x,L,b,R)}function A(x){const M=zg(x,Ih({},t)),L=M.context(),b=a(0,L.offset,L.startLoc);return e&&b.loc&&(b.loc.source=x),b.body=p(M),t.onCacheKey&&(b.cacheKey=t.onCacheKey(x)),L.currentType!==14&&r(M,Ie.UNEXPECTED_LEXICAL_ANALYSIS,L.lastStartLoc,0,x[L.offset]||""),o(b,M.currentOffset(),M.currentPosition()),b}return{parse:A}}function vn(t){if(t.type===14)return"EOF";const e=(t.value||"").replace(/\r?\n/gu,"\\n");return e.length>10?e.slice(0,9)+"…":e}function qg(t,e={}){const n={ast:t,helpers:new Set};return{context:()=>n,helper:s=>(n.helpers.add(s),s)}}function hu(t,e){for(let n=0;n<t.length;n++)lc(t[n],e)}function lc(t,e){switch(t.type){case 1:hu(t.cases,e),e.helper("plural");break;case 2:hu(t.items,e);break;case 6:{lc(t.key,e),e.helper("linked"),e.helper("type");break}case 5:e.helper("interpolate"),e.helper("list");break;case 4:e.helper("interpolate"),e.helper("named");break}}function jg(t,e={}){const n=qg(t);n.helper("normalize"),t.body&&lc(t.body,n);const i=n.context();t.helpers=Array.from(i.helpers)}function Kg(t){const e=t.body;return e.type===2?pu(e):e.cases.forEach(n=>pu(n)),t}function pu(t){if(t.items.length===1){const e=t.items[0];(e.type===3||e.type===9)&&(t.static=e.value,delete e.value)}else{const e=[];for(let n=0;n<t.items.length;n++){const i=t.items[n];if(!(i.type===3||i.type===9)||i.value==null)break;e.push(i.value)}if(e.length===t.items.length){t.static=Dh(e);for(let n=0;n<t.items.length;n++){const i=t.items[n];(i.type===3||i.type===9)&&delete i.value}}}}const Zg="minifier";function Ir(t){switch(t.t=t.type,t.type){case 0:{const e=t;Ir(e.body),e.b=e.body,delete e.body;break}case 1:{const e=t,n=e.cases;for(let i=0;i<n.length;i++)Ir(n[i]);e.c=n,delete e.cases;break}case 2:{const e=t,n=e.items;for(let i=0;i<n.length;i++)Ir(n[i]);e.i=n,delete e.items,e.static&&(e.s=e.static,delete e.static);break}case 3:case 9:case 8:case 7:{const e=t;e.value&&(e.v=e.value,delete e.value);break}case 6:{const e=t;Ir(e.key),e.k=e.key,delete e.key,e.modifier&&(Ir(e.modifier),e.m=e.modifier,delete e.modifier);break}case 5:{const e=t;e.i=e.index,delete e.index;break}case 4:{const e=t;e.k=e.key,delete e.key;break}default:throw Zr(Ie.UNHANDLED_MINIFIER_NODE_TYPE,null,{domain:Zg,args:[t.type]})}delete t.type}const Jg="parser";function Qg(t,e){const{filename:n,breakLineCode:i,needIndent:r}=e,s=e.location!==!1,a={filename:n,code:"",column:1,line:1,offset:0,map:void 0,breakLineCode:i,needIndent:r,indentLevel:0};s&&t.loc&&(a.source=t.loc.source);const o=()=>a;function l(v,m){a.code+=v}function c(v,m=!0){const p=m?i:"";l(r?p+"  ".repeat(v):p)}function u(v=!0){const m=++a.indentLevel;v&&c(m)}function f(v=!0){const m=--a.indentLevel;v&&c(m)}function d(){c(a.indentLevel)}return{context:o,push:l,indent:u,deindent:f,newline:d,helper:v=>`_${v}`,needIndent:()=>a.needIndent}}function ev(t,e){const{helper:n}=t;t.push(`${n("linked")}(`),Xr(t,e.key),e.modifier?(t.push(", "),Xr(t,e.modifier),t.push(", _type")):t.push(", undefined, _type"),t.push(")")}function tv(t,e){const{helper:n,needIndent:i}=t;t.push(`${n("normalize")}([`),t.indent(i());const r=e.items.length;for(let s=0;s<r&&(Xr(t,e.items[s]),s!==r-1);s++)t.push(", ");t.deindent(i()),t.push("])")}function nv(t,e){const{helper:n,needIndent:i}=t;if(e.cases.length>1){t.push(`${n("plural")}([`),t.indent(i());const r=e.cases.length;for(let s=0;s<r&&(Xr(t,e.cases[s]),s!==r-1);s++)t.push(", ");t.deindent(i()),t.push("])")}}function iv(t,e){e.body?Xr(t,e.body):t.push("null")}function Xr(t,e){const{helper:n}=t;switch(e.type){case 0:iv(t,e);break;case 1:nv(t,e);break;case 2:tv(t,e);break;case 6:ev(t,e);break;case 8:t.push(JSON.stringify(e.value),e);break;case 7:t.push(JSON.stringify(e.value),e);break;case 5:t.push(`${n("interpolate")}(${n("list")}(${e.index}))`,e);break;case 4:t.push(`${n("interpolate")}(${n("named")}(${JSON.stringify(e.key)}))`,e);break;case 9:t.push(JSON.stringify(e.value),e);break;case 3:t.push(JSON.stringify(e.value),e);break;default:throw Zr(Ie.UNHANDLED_CODEGEN_NODE_TYPE,null,{domain:Jg,args:[e.type]})}}const rv=(t,e={})=>{const n=fu(e.mode)?e.mode:"normal",i=fu(e.filename)?e.filename:"message.intl";e.sourceMap;const r=e.breakLineCode!=null?e.breakLineCode:n==="arrow"?";":`
...
#endif`,NE="gl_FragColor = linearToOutputTexel( gl_FragColor );",UE=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function qf(){return new lr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xc(),fragmentShader:`
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function jf(){return new lr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xc(),fragmentShader:`
...
`+Yy(t.getShaderSource(e),a)}else return r}function qy(t,e){const n=$y(e);return`vec4 ${t}( vec4 value ) { return ${n[0]}( ${n[1]}( value ) ); }`}function jy(t,e){let n;switch(e){case sx:n="Linear";break;case ax:n="Reinhard";break;case ox:n="OptimizedCineon";break;case lx:n="ACESFilmic";break;case ux:n="AgX";break;case cx:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}function Ky(t){return[t.extensionDerivatives||t.envMapCubeUVHeight||t.bumpMap||t.normalMapTangentSpace||t.clearcoatNormalMap||t.flatShading||t.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(t.extensionFragDepth||t.logarithmicDepthBuffer)&&t.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",t.extensionDrawBuffers&&t.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(t.extensionShaderTextureLOD||t.envMap||t.transmission)&&t.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Fr).join(`
...
`].filter(Fr).join(`
`)),a=Ol(a),a=rd(a,n),a=sd(a,n),o=Ol(o),o=rd(o,n),o=sd(o,n),a=ad(a),o=ad(o),n.isWebGL2&&n.isRawShaderMaterial!==!0&&(x=`#version 300 es
